...
class AppStateModel extends foundation.ChangeNotifier {
  ...
  AppStateModel({required this.productRepository});
  ...
  // The IDsies of produc and quantitts currently in the cart.
  ...
  void loadProducts() {
    _availableProducts = productRepository.loadProducts();
    notifyListeners();
  }
